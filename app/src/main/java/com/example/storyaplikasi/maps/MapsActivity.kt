package com.example.storyaplikasi.maps
...
import com.example.storyaplikasi.databinding.ActivityMapsBinding
...
class MapsActivity : AppCompatActivity(), OnMapReadyCallback {
    ...
    override fun onMapReady(googleMap: GoogleMap) {
        ...
        api.getStories(
            "Bearer " + intent.getStringExtra("api_key")
                ...
                if (response.isSuccessful) {
                    if (data != null) {
                        for (i in data.listStory) {
                            mMap.addMarker(
                                MarkerOptions().position(LatLng(i.lat, i.lon)).title(i.name)
                            )
                        }
